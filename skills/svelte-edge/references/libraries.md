...
| Data display and virtualization | LayerChart · TanStack Table · TanStack Virtual | Custom SVG/D3-style marks · headless datagrids (Svelte-native adapter wired directly to runes) · DOM virtualization for very long lists (~10,000+ rows). Unovis was eliminated here: its v1.5 release removed Svelte 5 from its supported peers pending an upstream migration — do not reintroduce without verified Svelte 5 support. |
